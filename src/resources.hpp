...
/* Depth enum */
typedef enum {FRONT_DEPTH=0, FONT_DEPTH=60000, OVERLAY_DEPTH=60001, OBJECT_DEPTH, CORNER_DEPTH, WALL_DEPTH, FLOOR_DEPTH, BACK_DEPTH} DEPTH_ENUM;
...
BOMB_1,BOMB_2,BOMB_3,BOMB_4,BOMB_5,BOMB_6,BOMB_7,BOMB_8,BOMB_9,GOLD_BLOCK}
ROOM_SPRITE_ENUM ;
