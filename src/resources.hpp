...
typedef enum {ALWAYS_PRED=0, NEVER_PRED, READY_PRED, ALIVE_PRED, DEAD_PRED, DAMAGE_PRED, HIT_PRED, SCORE_PRED, WINNING_PRED, LOSING_PRED, BLOCKED_PRED, COLLECT_PRED, NUM_PRED_TYPES} PRED_TYPE;
